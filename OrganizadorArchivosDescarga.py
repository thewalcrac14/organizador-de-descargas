...
class OrganizadorDefinitivo(ctk.CTk):
    def __init__(self):
        ...
        # VENTANA COMPLETAMENTE REDIMENSIONABLE
        self.resizable(True, True)
        ctk.set_appearance_mode("dark")
        ctk.set_default_color_theme("blue") 

        # Configurar adaptabilidad del layout principal
        ...
        # Configurar expansión de filas y columnas del contenedor
        self.main_container.grid_columnconfigure(0, weight=1)
        self.main_container.grid_rowconfigure(6, weight=1) # La caja de texto/consola se expandirá
        ...
        # Botón Rojo optimizado para evitar desbordamiento visual
        ...
        # 4. Terminal / Consola Interactiva CMD
